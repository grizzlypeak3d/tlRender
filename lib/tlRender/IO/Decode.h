...
namespace tl
{
    ...
    class TL_API_TYPE IDecode : public std::enable_shared_from_this<IDecode>
    {
    ...
    public:
        ...
        TL_API virtual double getSpeed(const IOInfo&, double defaultSpeed) const;
    };
}
