...
namespace tl
{
    ...
    class TL_TIMELINE_API_TYPE IRender : public ftk::IRender
    {
    public:
        TL_TIMELINE_API virtual ~IRender() = 0;

        //! Set the OpenColorIO options.
        TL_TIMELINE_API virtual void setOCIOOptions(const OCIOOptions&) = 0;
        ...
        TL_TIMELINE_API virtual void setOCIOInputResolver(
            const std::function<std::string(
                const std::string& path,
                const ftk::ImageTags&)>&) = 0;

        //! Set the LUT options.
        TL_TIMELINE_API virtual void setLUTOptions(const LUTOptions&) = 0;

        //! Draw the background.
        TL_TIMELINE_API virtual void drawBackground(
        ...
        TL_TIMELINE_API virtual void drawVideo(
